        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.pop(context);
                _confirmDeleteFile(context, ref, fileId, fileName, folderId);
              },
            ),
          ],
        ),
          ...
          TextButton(
            onPressed: () async {
              ...
              await ref
                  .read(storageControllerProvider.notifier)
                  .deleteFile(fileId);
              // Refresh storage detail after deleting file
              await ref
                  .read(storageControllerProvider.notifier)
      ...
      children: [
        for (int i = 0; i < storageDetail.files.length; i++) ...[
          RecentUploadItem(
            ...
            fileDate: _formatDate(storageDetail.files[i].createdAt),
            fileSize: _formatFileSize(storageDetail.files[i].sizeBytes),
